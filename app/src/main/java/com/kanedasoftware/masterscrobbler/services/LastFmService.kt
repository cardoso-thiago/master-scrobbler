...
interface LastFmService {
    ...
    fun validateTrackAndArtist(@Query("api_key") apiKey: String, @Query("track") track: String, @Query("artist") artist: String):Call<TrackInfo>

    @GET("?method=track.search&limit=1&format=json")
    fun validateTrack(@Query("api_key") apiKey: String, @Query("track") track: String):Call<TrackInfo>
